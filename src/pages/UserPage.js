...
import { Form } from 'src/sections/@dashboard/user/form';
import { deleteUser, getUserList } from 'src/services/user';
  ...
  return (
    <>
      ...
      >
        ...
        <MenuItem onClick={e => handleClick(e, selectedUser._id)} sx={{ color: 'error.main' }}>
      ...
      >
        <Box sx={{
          ...
          <Divider sx={{ my: 1 }} />
          <Form userData={selectedUser} refresh={getList} />
        </Box>
      </Modal>
    </>
  );
